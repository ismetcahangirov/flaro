...
| **Aktiv branch** | `chore/rename-to-flaro` |
| **Növbəti branch** | `feature/m01-database` |
| **Növbəti tapşırıq** | Mərhələ 1 — Verilənlər Bazası (ad düzəlişi PR merge-dən sonra) |
| **Bloklanmış tapşırıq** | Yoxdur |
| **Qeyd** | Mərhələ 0 merge edildi. Layihə adı Flaro kimi düzəldilir; bu PR merge edildikdən sonra Mərhələ 1-ə keç. Ümumi progress 13%. |
