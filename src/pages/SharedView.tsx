...
export default function SharedView() {
  ...
  return (
    <div className="fixed inset-0 bg-slate-50 overflow-hidden flex flex-col font-sans text-slate-800">
      ...
      {/* Top Header */}
      <header className="bg-white border-b border-slate-100 px-6 py-4 flex items-center justify-between shadow-sm z-10 flex-shrink-0">
        {isLoading ? (
          /* Loading zamanı skeleton header */
          <div className="flex items-center gap-3">
      ...
      {/* Canvas Area — həmişə render olunur ki, useCanvas render loop başlasın */}
      <div className="flex-1 relative overflow-hidden bg-white">

        {/* Loading overlay — canvas üzərindədir amma canvas həmişə DOM-dadır */}
        {isLoading && (
